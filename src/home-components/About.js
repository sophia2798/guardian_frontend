...
function About() {
    return (
        <div className="about">
            ...
            <br />
            <br />
            Composed of a development team of professionals with extensive international experience, Guardian Inc. uses a mixture of employees and trusted partners to provide a state of the art application that provides a broad range of services.
            </p>
            <h4 className="about__summary">
                PLAN. EXECUTE.
            </h4>
        </div>
    )
