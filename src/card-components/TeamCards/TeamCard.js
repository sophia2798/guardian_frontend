...
export default function TeamCard(props) {
  ...
  return (
    <Card
      className={active ? classes.cardCurrent : classes.cardComplete}
      id="team-card"
    >
      <CardHeader
        ...
        avatar={
          <Avatar
            aria-label="recipe"
            className={active ? classes.avatarCurrent : classes.avatarComplete}
          >
            &nbsp;
          </Avatar>
        }
          ...
          <div
            ...
            className={`${
              navy
                ...
                ? classes.blackBlue
                : null
            } ${moreInfo ? classes.expanded_list : null}`}
          >
              ...
              <img
                ...
                src={
                  member.position === "Agent"
                    ...
                    ? lead
                    : member.position === "Medic"
                    ? medical
                    : member.position === "Advance Lead"
                    ? advance
                    : null
                }
                alt="avatar"
      ...
      >
        ...
        <AddIcon onClick={props.handleOpen} id="add-member"/>
